// Pages
export { default as FlatRatesPage } from './pages/FlatRatesPage';
export { default as CreateNewFlatRatePage } from './pages/CreateNewFlatRatePage';
...
export { EditFlatRateModal } from './components/EditFlatRateModal';
