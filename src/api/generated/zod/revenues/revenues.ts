...
export const GetAllDailyRevenuesQueryParams = zod.object({
  ...
  "page": zod.int().min(1).default(getAllDailyRevenuesQueryPageDefault).describe('Page number (1-indexed, minimum 1)'),
  "size": zod.int().min(1).default(getAllDailyRevenuesQuerySizeDefault).describe('The size of the page to be returned'),
