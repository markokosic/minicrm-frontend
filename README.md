...
**Stage Environment:** https://taxi-stage.example.com  
**Email:** user@tenant.com | **Password:** <your_password>

**Repositories:**  
- **Frontend:** https://github.com/markokosic/taxios-frontend-web  
- **Backend:** https://github.com/markokosic/taxios-backend *(Java 21 / Spring Boot REST API & PostgreSQL Multi-Tenancy)*
...
1. **Revenue Tracking & Driver/Company Payout Splits**
   ...
   - *Solution:* Daily shift revenue logging (cash, card, tips). The system automatically calculates cent-accurate driver payouts and net company shares based on each driver's assigned remuneration contract.
...
2. **Fleet & Driver Management**
   ...
   - *Solution:* Clear separation of vehicle assets (cars) and human resources (drivers) for shift and cost assignment.
...
3. **Financial Reporting & Multi-Tenancy**
   ...
   - *Solution:* Reports over customizable date ranges with dynamic grouping by `DRIVER`, `CAR`, or `DATE`, backed by tenant-isolated data.
